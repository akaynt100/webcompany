...
@section('content')
    <div class="main-content">
        <section class="container">
            ...
            <form class="user-form form" action="{{ url('/password/reset') }}" method="POST">
                ...
                <div class="field__wrap">
                    <label class="field__label custom-placeholder-wrap">
                        <input type="email" name="email" class="field" placeholder="" required>
                ...
                <div class="field__wrap">
                    <label class="field__label custom-placeholder-wrap">
                        ...
                        <span class="custom-placeholder">Новый пароль</span>
                    </label>
                </div>
                <div class="field__wrap">
                    <label class="field__label custom-placeholder-wrap">
                        <input type="password" name="password_confirmation" class="field" placeholder="" required>
